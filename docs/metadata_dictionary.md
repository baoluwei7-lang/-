...
| cell_type | cell_ontology_class | category | 8 | 0.0% | endothelial cell, B cell, mesenchymal stem cell of adipose |
...
| cell_type | cell_ontology_class | category | 9 | 0.0% | hepatocyte, endothelial cell of hepatic sinusoid, Kupffer cell |
| assay | method | category | 1 | 0.0% | droplet |
...
| cell_type | cell_ontology_class | category | 30 | 0.0% | B cell, non-classical monocyte, NK cell |
| assay | method | category | 1 | 0.0% | droplet |
...
| 标准字段 | 实际列名 | 类型 | 唯一值 | 缺失率 | 示例值 |
|----------|----------|------|--------|--------|--------|
| mouse_id | mouse.id | category | 17 | 0.0% | 18-F-50, 18-F-51, 18-M-52 |
| age_months | age | category | 6 | 0.0% | 18m, 21m, 24m |
| sex | sex | category | 2 | 0.0% | female, male |
| tissue | tissue | category | 1 | 0.0% | Marrow |
| cell_type | cell_ontology_class | category | 18 | 0.0% | naive T cell, hematopoietic precursor cell, monocyte |
| assay | method | category | 1 | 0.0% | droplet |
...
| 标准字段 | 实际列名 | 类型 | 唯一值 | 缺失率 | 示例值 |
|----------|----------|------|--------|--------|--------|
| mouse_id | mouse.id | category | 13 | 0.0% | 18-F-50, 18-F-51, 21-F-54 |
| age_months | age | category | 6 | 0.0% | 18m, 21m, 24m |
| sex | sex | category | 2 | 0.0% | female, male |
| tissue | tissue | category | 1 | 0.0% | Spleen |
| cell_type | cell_ontology_class | category | 12 | 0.0% | B cell, mature NK T cell, plasma cell |
| assay | method | category | 1 | 0.0% | droplet |
...
| cell_type | cell_ontology_class | category | 23 | 0.0% | kidney proximal convoluted tubule epithelial cell, macrophage, B cell |
| assay | method | category | 1 | 0.0% | droplet |
...
| cell_type | cell_ontology_class | category | 9 | 0.0% | fibroblast of cardiac tissue, leukocyte, endocardial cell |
| assay | method | category | 1 | 0.0% | droplet |
